...
pdf(file='05-hysteresis.pdf',width=16, height=10)

simple_queue <- read.table("hysteresis.data", header = TRUE)

plot(simple_queue$time, simple_queue$q1_mean, xlab='', ylab='', type='l', ylim=c(0,60), col=c('#2a8592'), lwd="2", xaxt='n', xlim=c(0,10000), bty="n")
...
rect(2000, 0, 3500, 10, col="#00000020", border=NA)
